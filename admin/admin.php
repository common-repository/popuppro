...
class popuppro_admin {
	...
	?>
	<div role="alert" class="alert alert-success" style="background:linear-gradient(#2e9afe, #2e9afe) repeat scroll 0 0 rgba(0, 0, 0, 0);  padding: 1px 12px !important;color:#fff"><h4>Get Flat 25% off on
                <a style="color:green" target="_blank" href="http://www.wpseeds.com/product/popuppro/">PopUp Pro Plugin.</a> 
                Use Coupon code 'WPSEEDS25'</h4></div>
